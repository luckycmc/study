...
insert  into `lt_user`(`id`,`username`,`blacktime`,`realname`,`mobile`,`address`,`sys_created`,`sys_updated`,`sys_ip`) values (1,'吾爱程序猿论坛',0,'www.52programer.com','11111111111','abcdefg',0,1532595094,'');
